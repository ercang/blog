...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5b52b69544f04d351c224d0c03f203ebfdccf58dba9bbe705fe4c3549c3260c0.js',function(){input.required=false;search();});}
